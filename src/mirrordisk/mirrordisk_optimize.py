...
def optimize_xcen(initial_guess, xx_inp, yy_inp, interpolator, vec_val_arr):
    ...
    result = minimize(compute_res_asym_vsys_pa_fixed, initial_guess[1], args=(vsys, pa_rad, xx_inp, yy_inp, interpolator, vec_val_arr), method=scipy_opt_method)
    return result
...
def optimize_vsys(initial_guess, xx_inp, yy_inp, interpolator, vec_val_arr):
    ...
    pa_rad = initial_guess[2]
    result = minimize(compute_res_asym_x_cen_pa_fixed, initial_guess[:1], args=(x_cen, pa_rad, xx_inp, yy_inp, interpolator, vec_val_arr), method=scipy_opt_method)
    return result
...
def optimize_vsys_xcen(initial_guess, xx_inp, yy_inp, interpolator, vec_val_arr):
    ...
    """
    pa_rad = initial_guess[2]
    result = minimize(compute_res_asym_pa_fixed, initial_guess[:2], args=(pa_rad, xx_inp, yy_inp, interpolator, vec_val_arr), method=scipy_opt_method)
    return result
...
def optimize_vsys_xcen_pa(initial_guess, xx_inp, yy_inp, interpolator, vec_val_arr):
    ...
    result : scipy.optimize.OptimizeResult
        Result of the optimization.
    """
    result = minimize(compute_res_asym, initial_guess, args=(xx_inp, yy_inp, interpolator, vec_val_arr), method=scipy_opt_method)
    return result
